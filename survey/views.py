...
def show_result(request):
    ...
    answer = [ans.ans1, ans.ans2, ans.ans3, ans.ans4, ans.ans5]
...
def update(request):
    ...
    addq = Survey(survey_idx=idv, question=question, ans1=ans1, ans2=ans2, ans3=ans3, ans4=ans4, ans5=ans5, status=status)
...
# 파이차트 만들기
def chart1(request):
    return render(request,"survey/chart.html")